...
export SOURCE_DATE_EPOCH="1787659200"
...
"$TECTONIC" -X compile "$ROOT/PAPER/source/JENSEN_TWO_THIRDS_UNIFIED.tex" --outdir "$TMP_DIR"
...
cmp "$TMP_DIR/JENSEN_TWO_THIRDS_UNIFIED.pdf" "$ROOT/PAPER/JENSEN_TWO_THIRDS_UNIFIED.pdf"
printf '%s
