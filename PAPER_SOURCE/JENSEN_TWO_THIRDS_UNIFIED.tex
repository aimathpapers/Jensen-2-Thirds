...
\textbf{AI-assistance disclosure.} These papers and the accompanying Lean 4
...
testing and AI-only technical review.  \textbf{Wolfram Mathematica 15.0.1},
executed by the author, supplied clean-room computational corroboration of
selected symbolic identities and exact algebraic calculations.  AI systems
are not authors, and no human mathematical review or peer review is claimed.}}
\end{center}
...
The Version 1.1 public-release set contains this source and rendered PDF,
...
surface.  The permanent Version 1.1 record is
\href{https://doi.org/10.5281/zenodo.22293642}{\texttt{10.5281/zenodo.22293642}};
corrections should appear as new versions rather than silent file replacement.
