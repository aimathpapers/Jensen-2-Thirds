...
record supersedes those earlier distribution labels. The substantive evidence
files are retained byte-for-byte so that review history, findings, repairs,
and calculations remain auditable.
...
Frozen Mathematica notebooks, execution ledgers, and historical AI-review
reports contain a small number of workstation paths. Those paths are
provenance text, not active dependencies. They are confined to the historical
evidence tree and are preserved rather than silently rewriting a calculation
or review record.

No human mathematical review or peer review is claimed. The included review
reports were produced by AI systems. The formal boundary and the explicitly
typed literature inputs are documented in
